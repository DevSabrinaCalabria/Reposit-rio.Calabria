#Implemente uma classe para representar em vetor (x,y,z) no R3 . Implemente os metodos para calcular a soma, subtracao, produto vetorial, produto escalar e modulo.
class Vetor3D:
